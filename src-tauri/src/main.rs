...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api_tauri_commands::deepseek_commands::generate_screener_conditions,
            ...
            api_tauri_commands::commands_v2::indicator_backtest,
            ...
            api_tauri_commands::commands_v2::get_kronos_history,
            ...
            api_tauri_commands::commands_v2::delete_screener_result,
            api_tauri_commands::commands_v2::clear_screener_history,
            api_tauri_commands::commands_v2::save_strategy,
            api_tauri_commands::commands_v2::get_all_strategies,
            api_tauri_commands::commands_v2::delete_strategy,
            api_tauri_commands::commands_v2::update_strategy,
